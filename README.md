Steps to setup run rjsf_native app

Optional: Install Watchman for watching changes in the filesystem,
(recommended by React Native team for better performance).
...
3. Run the app:
    iOS version: `npm run ios-dev`
    Web version: `npm run web-dev`
